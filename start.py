...
if __name__ == '__main__':
    ...
    uc_url = "http://sso.bytedance-inc.org/next.html?url=http://iflow.uczzd.cn/iflow/api/v1/article/3252968475747632673/related_video?app=uc-iflow&cid=10012&count=" \
